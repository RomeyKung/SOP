package com.example.lab6addcache.view;


import com.example.lab6addcache.pojo.Wizard;
import com.example.lab6addcache.pojo.Wizards;
...
//            index = wizardList.size();
        ...
        this.update.addClickListener(event -> {
            ...
            List<Wizard> wizardReturn = WebClient.create().post()
                    .uri("http://localhost:8081/updateWizard").contentType(MediaType.APPLICATION_FORM_URLENCODED)
                    .body(BodyInserters.fromFormData(formData)).retrieve().bodyToMono(List.class).block();
